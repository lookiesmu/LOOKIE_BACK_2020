...
<body>
    <div id="container">
        ...
        <div class="event">
            ...
            <div class="section_event_lst">
                <p class="event_lst_txt">바로 예매 가능한 행사가 <span class="pink">50개</span> 있습니다</p>
    ...
    <li class="item" style="background-image: url(resources/{ProductImageId});">
        ...
        <li class="item">
            <a href="detail.html?id={id}" class="item_book">
                <div class="item_preview">
                    <img alt="{description}" class="img_thumb" src="resources/{ProductImageId}">
