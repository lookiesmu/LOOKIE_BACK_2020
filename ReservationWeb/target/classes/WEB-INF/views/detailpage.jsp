...
<body>
    <div id="container">
        ...
        <div class="ct main">
            <div>
                <div class="section_visual">
                    <header>
                        ...
                        <c:choose>
							...
							<c:otherwise>
								<a href="./myreservation.jsp" class="btn_my"> <span
									class="viewReservation" title="예약확인" style="font-size: 18px">${loginInfo}</span>
								</a>
							</c:otherwise>
						</c:choose>
                    </header>
                ...
                <div class="section_btn"> <button type="button" class="bk_btn" onclick="location.href='./detail/reserve?id=${displayInfoId }'"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button> </div>
                <div class="section_review_list">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <span class="join_count">
                                	<!-- 한줄평 갯수 등록 -->
                                	<em class="green" id="totalComments"></em> 등록</span>
                            </div>
                    ...
                    <a class="btn_review_more" href="./detail/review?id=${displayInfoId }"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/4.7.6/handlebars.min.js"  type="text/javascript" charset="UTF-8"></script>
	<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
	<script src="resources/js/reservation.js" type="text/javascript" charset="UTF-8"></script>
	<script src="resources/js/detail.js" type="text/javascript" charset="UTF-8"></script>
	
	
	<script type="Tepmlate" id="displayInfoTemplate">
	{{#each productImages}}
	<li class="item" style="width: 414px;"><img alt=""
		class="img_thumb" src="resources/{{this.saveFileName}}"> <span class="img_bg"></span>
		<div class="visual_txt" style="height:414px">
	...
	<script type="Tepmlate" id="reviewTemplate">
	{{#each comments}}
			...
			<div class="review_area">
				<div class="thumb_area">
					<a href="#" class="thumb" title="이미지 크게 보기"> <img width="90"
						...
						src="resources/{{this.commentImages.0.saveFileName}}" alt="리뷰이미지">
					</a> <span class="img_count">{{this.commentImages.length}}</span>
				</div>
	...
	<script type="Tepmlate" id="locationTemplate">
