...
public class WebApplicationInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
	 @Override
	    protected Class<?>[] getRootConfigClasses() {
	        return new Class<?>[]{kr.or.connect.reservation.config.ApplicationConfig.class,
	        	kr.or.connect.reservation.config.sequrity.SecurityConfig.class};
	    }

	    // Spring MVC 설정 파일 클래스를 지정한다.
	    @Override
	    protected Class<?>[] getServletConfigClasses() {
	        return new Class<?>[]{kr.or.connect.reservation.config.WebMvcContextConfiguration.class	        	};
	    }
