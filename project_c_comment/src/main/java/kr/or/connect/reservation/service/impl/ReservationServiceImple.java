...
public class ReservationServiceImple implements ReservationService{
	...
	@Autowired
	ReservationUserCommentImageDao reservationUserCommentImagesDao;
	...
	public int insertComments(int productId, int reservationInfoId, Long userId, int score, String comment) {
		return reservationUserCommentsDao.insertComments(productId, reservationInfoId, userId, score, comment);
	}
	@Override
	public int getreservationUserCommentId(int reservationInfoId, Long userId, int score, String comment) {
		return reservationUserCommentsDao.getreservationUserCommentId(reservationInfoId, userId, score, comment);
	}
	@Override
	public int insertFileInfo(String fileName) {
		return fileInfoDao.insertFileInfo(fileName);
	}
	@Override
	public int getFileId(String fileName) {
		return fileInfoDao.getFileId(fileName);
	}
	@Override
	public int insertUserCommentImage(int reservationInfoId, int reservationUserCommentId, int fileId) {
		return reservationUserCommentsDao.insertUserCommentImage(reservationInfoId, reservationUserCommentId, fileId);
	}
	@Override
	public List<ReservationUserCommentImages> getReservationUserCommentImages(){
		return reservationUserCommentImagesDao.getReservationUserCommentImages();
	}
	@Override
	public ReservationUserCommentImages getReservationUserCommentImagesFile(int fileId) {
		return reservationUserCommentImagesDao.getReservationUserCommentImagesFile(fileId);
	}
}
