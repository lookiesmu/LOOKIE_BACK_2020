...
import static kr.or.connect.reservation.dao.sqls.UserSqls.USER_ROLE_ALL_BY_EMAIL;
...
public class UserRoleDao {
	...
	public List<UserRole> getRole(String email){
		Map<String, Object> params = new HashMap<>();
		params.put("email", email);

		return jdbc.query(USER_ROLE_ALL_BY_EMAIL, params, rowMapper);
	}
}
